...
`;
  ...
  // Update Search Bar
  const replacementHTML = `<div className="flex gap-4">
  ...
  // Regex to match the entire <div className="relative w-72">...</div> block regardless of whitespace
  content = content.replace(/<div className="relative w-72">[\s\S]*?<\/div>/, replacementHTML);
